...
// const initContact: ContactInformation[] = [
...
export const useContactIdList = (value?: string) => { // connect vao store de lay ra danh sach
    return useSelector((state: any) => state.contacts.query.all.map((key: string) => ({
        key,
